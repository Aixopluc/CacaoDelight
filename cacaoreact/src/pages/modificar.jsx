    ...
    <div className="bg-cdverde min-h-screen">
      <div className="container mx-auto w-[400px]">
        ...
        {leido && pale.NumeroDePale !== 0 ? (
          <div>
            <div className="mb-4">
              <label htmlFor="producto" className="block mb-1 text-cream">Producto:</label>
              <select
                id="producto"
                name="Producto"
                value={pale.Producto}
            ...
            <div className="mb-4">
              <label htmlFor="kg" className="block mb-1 text-cream">Kilogramos (kg):</label>
              <input
                type="text"
                id="kg"
                name="Kg"
            ...
            <div className="mb-4">
              <label htmlFor="lote" className="block mb-1 text-cream">Lote:</label>
              <input
                type="text"
                id="lote"
                name="Lote"
            ...
            <div className="mb-4">
              <label htmlFor="estado" className="block mb-1 text-cream">Estado:</label>
              <select
                type="text"
                name="Estado"
                id="estado"
            ...
            <div className="mb-4">
              <label htmlFor="numeroEtiqueta" className="block mb-1 text-cream">Número de etiqueta:</label>
              <input
                type="text"
                name="NumeroDePale"
                id="numeroEtiqueta"
            ...
            <div className="flex justify-evenly items-center">
              <button
                ...
                className="bg-cream text-cdverde px-4 py-2 rounded-md hover:bg-blue-600 focus:outline-none focus:bg-blue-600"
              >
                Modificar
              </button>
              <button
